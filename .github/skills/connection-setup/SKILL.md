...
Supported SDK connector names: `arm`, `azureautomation`, `azuredatafactory`, `azuredigitaltwins`, `azuremonitorlogs`, `azuread`, `azureblob`, `box`, `azurequeues`, `azuretables`, `azurevm`, `commondataservice`, `campfire`, `clicksendsms`, `documentdb`, `dropbox`, `docusign`, `eventhubs`, `excelonline`, `excelonlinebusiness`, `freshservice`, `ftp`, `github`, `googlecalendar`, `googledrive`, `googletasks`, `infusionsoft`, `insightly`, `jira`, `keyvault`, `kusto`, `microsoftbookings`, `microsoftforms`, `monday`, `mailchimp`, `mq`, `msgraphgroupsanduser`, `office365`, `office365groups`, `office365groupsmail`, `office365users`, `onedrive`, `onedriveforbusiness`, `onenote`, `outlook`, `planner`, `plivo`, `powerbi`, `projectplace`, `revai`, `rss`, `salesforce`, `sendgrid`, `servicebus`, `sharepointonline`, `shifts`, `slack`, `smtp`, `starmind`, `tallyfy`, `teams`, `textrequest`, `todo`, `trello`, `twitter`, `webex`, `wordpress`, `wordonlinebusiness`, `yammer`, `wdatp`, `universalprint`, `azureeventgrid`, `azureiotcentral`, `cloudmersiveconvert`, `dynamicsax`, `pdfco`, `plumsail`, `sql`, `zendesk`, `pipedrive`, `docuware`, `signinghub`, `zohosign` (and any `Microsoft.Web/connections` connector name).
