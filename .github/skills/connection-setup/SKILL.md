...
Supported SDK connector names: `arm`, `azureautomation`, `azuredatafactory`, `azuredigitaltwins`, `azuremonitorlogs`, `azuread`, `azureblob`, `box`, `azurequeues`, `azuretables`, `azurevm`, `commondataservice`, `campfire`, `clicksendsms`, `documentdb`, `dropbox`, `docusign`, `eventhubs`, `excelonline`, `excelonlinebusiness`, `freshservice`, `ftp`, `github`, `googlecalendar`, `googledrive`, `googletasks`, `infusionsoft`, `insightly`, `jira`, `keyvault`, `kusto`, `microsoftbookings`, `microsoftforms`, `monday`, `mailchimp`, `mq`, `msgraphgroupsanduser`, `office365`, `office365groups`, `office365groupsmail`, `office365users`, `onedrive`, `onedriveforbusiness`, `onenote`, `outlook`, `planner`, `plivo`, `powerbi`, `projectplace`, `rss`, `salesforce`, `sendgrid`, `servicebus`, `sharepointonline`, `shifts`, `slack`, `smtp`, `teams`, `textrequest`, `todo`, `webex`, `wordonlinebusiness`, `yammer`, `wdatp`, `universalprint`, `azureeventgrid`, `azureiotcentral`, `cloudmersiveconvert`, `dynamicsax`, `pdfco`, `plumsail`, `sql`, `zendesk`, `pipedrive`, `docuware`, `signinghub` (and any `Microsoft.Web/connections` connector name).
