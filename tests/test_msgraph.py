...
class TestListUsers:
    ...
    async def test_success_with_json_response(self, mock_token_provider, mock_response_success):
        ...
        mock_response_success.text = '{"@odata.context": "https://graph.microsoft.com/v1.0/$metadata#users", "value": [{"id": "user1", "displayName": "User One"}]}'
...
class TestListGroupsByDisplayNameSearch:
    ...
    async def test_success_with_search_and_count(self, mock_token_provider, mock_response_success):
        ...
        mock_response_success.text = '{"@odata.context": "https://graph.microsoft.com/v1.0/$metadata#groups", "@odata.count": 2, "value": [{"id": "group1", "displayName": "Test Group"}]}'
...
class TestListSubscribedSkus:
    ...
    async def test_success_with_json_response(self, mock_token_provider, mock_response_success):
        ...
        mock_response_success.text = '{"value": [{"skuId": "sku1", "skuPartNumber": "ENTERPRISEPACK"}]}'
...
class TestListDirectGroupMembers:
    ...
    async def test_success_with_all_parameters(self, mock_token_provider, mock_response_success):
        ...
        mock_response_success.text = '{"@odata.count": 5, "value": [{"id": "member1", "displayName": "Member One"}]}'
    ...
    @pytest.mark.asyncio
    async def test_success_with_group_id_and_count_only(self, mock_token_provider, mock_response_success):
...
class TestGetMemberLicenseDetails:
    ...
    @pytest.mark.asyncio
    async def test_success_without_select_parameter(self, mock_token_provider, mock_response_success):
...
class TestGetGroupProperties:
    ...
    async def test_success_with_json_response(self, mock_token_provider, mock_response_success):
        ...
        mock_response_success.text = '{"id": "group-123", "displayName": "Test Group", "mailEnabled": true, "securityEnabled": false}'
...
class TestGetMemberGroups:
    ...
    @pytest.mark.asyncio
    async def test_success_with_security_enabled_only_true(self, mock_token_provider, mock_response_success):
    ...
    @pytest.mark.asyncio
    async def test_success_with_security_enabled_only_false(self, mock_token_provider, mock_response_success):
...
class TestEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_empty_string_parameters_excluded(self, mock_token_provider, mock_response_success):
