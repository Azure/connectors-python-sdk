...
- Initial Python SDK release with core abstractions
  ...
  - `TriggerCallbackPayload` — Generic types for AI Gateway trigger integration
...
- Setup script for creating AI Gateway connections (`Setup-Connection.ps1`)
- Documentation:
...
[Unreleased]: https://github.com/Azure/Connectors-Python-SDK/compare/v0.1.0dev2...HEAD
