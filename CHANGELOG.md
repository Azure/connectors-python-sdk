...
- Regenerated Microsoft To Do from its pinned managed connector contract using the current CodefulSdkGenerator, restoring Swagger wire-name metadata throughout the client. Microsoft Teams and Shifts were already byte-identical to current generator output and only receive collision serializer coverage.
