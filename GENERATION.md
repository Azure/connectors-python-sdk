...
| Operation methods corrected Swagger spelling or split acronym letters | Fixed in generator | `docusign`, `googletasks`, `pdfco`, `signinghub`, `slack`, `wordonlinebusiness`, `zohosign` | Fixed | Python now preserves operationId spelling and character order while applying deterministic acronym-aware snake_case. |
