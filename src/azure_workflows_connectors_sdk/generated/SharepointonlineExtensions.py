...
class SharepointonlineClient(ConnectorClientBase):
    ...
    async def get_all_tables_async(
        ...
        Get all lists and libraries.
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/alltables"
    ...
    async def approve_hub_site_join_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/approvehubsitejoin"
        query_params = []
    ...
    async def cancel_hub_site_join_approval_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/cancelhubsitejoinapproval"
        query_params = []
    ...
    async def create_sharing_link_async(
        ...
        Create sharing link for a file or folder.
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/codeless/_api/v2.0/sites/root/lists/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/driveItem/createLink"
    ...
    async def copy_file_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/copyFile"
        query_params = []
    ...
    async def copy_file_async_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/copyFileAsync"
    ...
    async def copy_folder_async_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/copyFolderAsync"
    ...
    async def extract_folder_v2_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/extractFolderV2"
        query_params = []
        if source is not None:
            query_params.append(f"source={source}")
        if destination is not None:
    ...
    async def create_file_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/files"
        query_params = []
    ...
    async def get_file_metadata_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/files/{{Uri.EscapeDataString(id.ToString())}}"
    ...
    async def get_file_content_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/files/{{Uri.EscapeDataString(id.ToString())}}/content"
        query_params = []
    ...
    async def list_root_folder_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/folders"
    ...
    async def list_folder_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/folders/{{Uri.EscapeDataString(id.ToString())}}"
    ...
    async def get_file_metadata_by_path_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/GetFileByPath"
        query_params = []
        if path is not None:
    ...
    async def get_file_content_by_path_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/GetFileContentByPath"
        query_params = []
        if path is not None:
            query_params.append(f"path={path}")
        if infer_content_type is not None:
    ...
    async def get_folder_metadata_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/GetFolder"
        query_params = []
        if id is not None:
    ...
    async def get_folder_metadata_by_path_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/GetFolderByPath"
        query_params = []
        if path is not None:
            query_params.append(f"path={path}")
        if query_parameters_single_encoded is not None:
    ...
    async def http_request_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/httprequest"
    ...
    async def join_hub_site_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/joinhubsite"
        query_params = []
    ...
    async def move_file_async_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/moveFileAsync"
    ...
    async def move_folder_async_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/moveFolderAsync"
    ...
    async def notify_hub_site_join_approval_started_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/notifyhubsitejoinapprovalstarted"
        query_params = []
        if approval_correlation_id is not None:
            query_params.append(f"approvalCorrelationId={approval_correlation_id}")
        if query_params:
    ...
    async def get_tables_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables"
    ...
    async def create_new_document_set_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/createnewdocumentset"
    ...
    async def create_new_folder_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/createnewfolder"
        query_params = []
        if view is not None:
    ...
    async def search_for_user_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/entities/{{Uri.EscapeDataString(entity_id.ToString())}}/searchforuser"
        query_params = []
    ...
    async def get_file_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/getfileitems"
        query_params = []
    ...
    async def get_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items"
        query_params = []
        if filter is not None:
            query_params.append(f"$filter={filter}")
        if orderby is not None:
    ...
    async def get_item_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}"
        query_params = []
        if view is not None:
            query_params.append(f"view={view}")
        if query_params:
    ...
    async def create_approval_request_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/approval"
        query_params = []
    ...
    async def get_item_changes_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/changes"
        query_params = []
    ...
    async def check_in_file_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/checkinfile"
    ...
    async def check_out_file_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/checkoutfile"
    ...
    async def discard_file_check_out_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/discardfilecheckout"
    ...
    async def get_file_item_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/getfileitem"
        query_params = []
        if view is not None:
            query_params.append(f"view={view}")
        if query_params:
    ...
    async def grant_access_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/grantaccess"
    ...
    async def patch_file_item_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/patchfileitem"
        query_params = []
        if view is not None:
            query_params.append(f"view={view}")
        if query_params:
    ...
    async def patch_file_item_with_predicted_values_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/patchfileitemwithpredictedvalues"
    ...
    async def set_approval_status_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/setapprovalstatus"
        query_params = []
    ...
    async def unshare_item_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(id.ToString())}}/unshare"
    ...
    async def get_item_attachments_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(item_id.ToString())}}/attachments"
    ...
    async def delete_attachment_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(item_id.ToString())}}/attachments/{{Uri.EscapeDataString(attachment_id.ToString())}}"
    ...
    async def get_attachment_content_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/items/{{Uri.EscapeDataString(item_id.ToString())}}/attachments/{{Uri.EscapeDataString(attachment_id.ToString())}}/$value"
    ...
    async def get_on_changed_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/onchangeditems"
        query_params = []
        if folder_path is not None:
            query_params.append(f"folderPath={folder_path}")
        if view is not None:
    ...
    async def get_on_deleted_file_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/ondeletedfileitems"
        query_params = []
        if folder_path is not None:
            query_params.append(f"folderPath={folder_path}")
        if query_params:
    ...
    async def get_on_deleted_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/ondeleteditems"
    ...
    async def get_on_new_file_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/onnewfileitems"
        query_params = []
        if folder_path is not None:
            query_params.append(f"folderPath={folder_path}")
        if view is not None:
    ...
    async def get_on_new_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/onnewitems"
        query_params = []
        if view is not None:
            query_params.append(f"view={view}")
        if query_params:
    ...
    async def get_on_updated_file_classified_times_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/onupdatedfileclassifiedtimes"
        query_params = []
        if folder_path is not None:
            query_params.append(f"folderPath={folder_path}")
        if view is not None:
    ...
    async def get_on_updated_file_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/onupdatedfileitems"
        query_params = []
        if folder_path is not None:
            query_params.append(f"folderPath={folder_path}")
        if view is not None:
    ...
    async def get_on_updated_items_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/onupdateditems"
        query_params = []
        if view is not None:
            query_params.append(f"view={view}")
        if query_params:
    ...
    async def create_content_assembly_document_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/templates/{{Uri.EscapeDataString(template.ToString())}}/createnewdocument"
        query_params = []
        if folder_path is not None:
            query_params.append(f"folderPath={folder_path}")
    ...
    async def get_table_views_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/tables/{{Uri.EscapeDataString(table.ToString())}}/views"
    ...
    async def create_agreements_solution_document_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/agreements/templates/{{Uri.EscapeDataString(template.ToString())}}/createnewdocument"
        query_params = []
    ...
    async def on_new_file_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/triggers/onnewfile"
        query_params = []
    ...
    async def on_updated_file_async(
        ...
        """
        path = f"{self._connection_runtime_url}/{{Uri.EscapeDataString(connection_id.ToString())}}/datasets/{{Uri.EscapeDataString(dataset.ToString())}}/triggers/onupdatedfile"
        query_params = []
        if folder_id is not None:
            query_params.append(f"folderId={folder_id}")
